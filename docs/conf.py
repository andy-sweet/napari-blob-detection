# -*- coding: utf-8 -*-
#
# napari-blob-detection documentation build configuration file, created by
...
project = u'napari-blob-detection'
copyright = u'2015, Andy Sweet'
author = u'Andy Sweet'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'napari-blob-detection Documentation',
     [author], 1)
]
